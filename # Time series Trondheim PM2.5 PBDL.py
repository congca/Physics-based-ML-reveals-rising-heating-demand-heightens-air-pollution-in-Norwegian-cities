...
# Load data
df = pd.read_excel("PM25TrondheimTS.xlsx")
...
# Define a physics-based loss function with L2 regularization
...
plt.title('Actual vs. Predicted Trondheim PM2.5 values based on PBDL')
plt.legend()
plt.show()
...
plt.title('The loss curves of the PBDL for the training set and the test set (The PM2.5 levels in Trondheim)')
...
# Find the corresponding training epoch
