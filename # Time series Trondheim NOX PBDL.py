...
# Load data
df = pd.read_excel("NOxTrondheimTS.xlsx")
...
plt.title('Actual vs. Predicted Trondheim NOx values based on PBDL')
plt.legend()
plt.show()
...
plt.title('The loss curves of the PBDL for the training set and the test set (The NOx levels in Trondheim)')
